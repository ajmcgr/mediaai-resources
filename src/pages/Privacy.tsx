...
const Privacy = () => {
  return (
    <Layout>
      <Helmet>
        <title>Privacy Policy — Media AI</title>
        <meta name="description" content="How Media AI (Works App, Inc.) collects, uses and retains your data." />
      </Helmet>

      <article className="container mx-auto px-4 py-16 max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-medium text-foreground mb-10">Privacy Policy</h1>

        <div className="space-y-10">
          <Section title="Who we are">
            <p>We are Works App, Inc., doing business as Media AI. Our website address is: https://www.trymedia.ai.</p>
          </Section>
          ...
          <Section title="Our contact address">
            <p>
              Works App, Inc.<br />
              447 Sutter St,<br />
              Ste 405 #3,<br />
