...
const Terms = () => {
  return (
    <Layout>
      <Helmet>
        <title>Terms of Service — Media AI</title>
        <meta name="description" content="Terms and conditions governing the use of Media AI's service." />
      </Helmet>

      <article className="container mx-auto px-4 py-16 max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-medium text-foreground mb-6">Terms of Service</h1>
        ...
        <P>Country refers to: The United States of America</P>
        <P>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Works App, Inc., 447 Sutter St, Ste 405 #3, San Francisco, CA 94108.</P>
        ...
        <P>Website refers to Media AI, accessible from https://www.trymedia.ai</P>
        ...
        <P>By accessing or using the Service:</P>
        <P>You agree to be bound by these Terms and Conditions.</P>
        <P>If You disagree with any part of these Terms and Conditions then You may not access the Service.</P>
        ...
        <H3>Free Trial</H3>
        <P>The Company may, at its sole discretion, offer a Subscription with a Free Trial for a limited period of time or usage.</P>
        ...
        <P>The Company further reserves the right to make formatting and edits and change the manner any Content. The Company can also limit or revoke the use of the Service if You post such objectionable Content.</P>
        ...
        <P>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@trymedia.ai and include in Your notice a detailed description of the alleged infringement.</P>
        ...
        <P>You can contact our copyright agent via email at support@trymedia.ai. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</P>
        ...
        <P>By email: support@trymedia.ai</P>
      </article>
    </Layout>
  );
};
