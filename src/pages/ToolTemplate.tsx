...
const toolsData: Record<string, ToolData> = {
  "beat-outlet-matcher": {
    ...
    description:
      "Paste your story and get a ranked list of beats and outlet types to target, plus suggested filters to use inside Media AI.",
    category: "Pitching",
    ...
    faqs: [
      { question: "How accurate are the beat matches?", answer: "Our AI analyzes your content against thousands of articles to provide 70-95% accuracy in beat matching." },
      { question: "Can I use this for different story types?", answer: "Yes! This works for press releases, feature stories, product launches, funding announcements, and more." },
    ],
    relatedTools: [
  ...
  "pitch-personalization-helper": {
    ...
    faqs: [
      { question: "How do you find recent coverage?", answer: "We analyze recent articles and social media activity to craft relevant, timely references." },
      { question: "Should I always use these exactly as written?", answer: "These are starting points. Feel free to customize them to match your voice and specific story." },
    ],
    relatedTools: [
  ...
  "subject-line-split-tester": {
    ...
    faqs: [
      { question: "What factors affect the score?", answer: "We analyze length, urgency, personalization, spam triggers, and industry best practices." },
    ],
    relatedTools: [
      { title: "Pitch Personalization Helper", slug: "pitch-personalization-helper" },
      { title: "Follow-Up Cadence Builder", slug: "follow-up-cadence-builder" },
  ...
  "pitch-fit-score-calculator": {
    ...
    faqs: [
      { question: "How is the score calculated?", answer: "We evaluate relevance, timing, personalization, clarity, and call-to-action strength." },
    ],
    relatedTools: [
      { title: "Pitch Personalization Helper", slug: "pitch-personalization-helper" },
      { title: "Subject Line Split-Tester", slug: "subject-line-split-tester" },
  ...
  "embargo-timing-planner": {
    ...
    faqs: [
      { question: "How far in advance should I pitch?", answer: "Typically 5-7 days for daily news, 2-3 weeks for features and long-lead publications." },
    ],
    relatedTools: [
  ...
  "follow-up-cadence-builder": {
    ...
    faqs: [
      { question: "How many follow-ups is too many?", answer: "Generally 2-3 follow-ups maximum, spaced 3-7 days apart for news, longer for features." },
    ],
    relatedTools: [
  ...
  "list-segmenter-lite": {
    ...
    faqs: [
      { question: "What format should my list be in?", answer: "Any format works - CSV, plain text, or even copy-pasted from spreadsheets." },
    ],
    relatedTools: [
  ...
  "contact-dedupe-clean-lite": {
    ...
    faqs: [
      { question: "What errors does it detect?", answer: "Invalid emails, formatting issues, obvious duplicates, and incomplete records." },
    ],
    relatedTools: [
  ...
  "outreach-sequence-generator": {
    ...
    faqs: [
      { question: "How should I space the emails?", answer: "Day 1, Day 4, Day 8 works well for most campaigns. Adjust based on your story urgency." },
    ],
    relatedTools: [
      { title: "Follow-Up Cadence Builder", slug: "follow-up-cadence-builder" },
      { title: "Subject Line Split-Tester", slug: "subject-line-split-tester" },
  ...
  "press-release-structure-builder": {
    ...
    faqs: [
      { question: "What press release types are supported?", answer: "Funding, product launches, partnerships, acquisitions, executive appointments, and more." },
    ],
    relatedTools: [
  ...
  "quote-polisher-pr": {
    ...
    faqs: [
      { question: "Will these still sound authentic?", answer: "Yes, we maintain the speaker's intent while improving clarity and media appeal." },
    ],
    relatedTools: [
  ...
  "coverage-tracker-template": {
    ...
    faqs: [
      { question: "Should I include all coverage?", answer: "Focus on tier-1 outlets and significant features. Quality over quantity works best." },
    ],
    relatedTools: [
  ...
  "utm-builder-pr-links": {
    ...
    faqs: [
      { question: "What's the best UTM structure for PR?", answer: "Source=outlet, Medium=pr/interview/feature, Campaign=your_campaign_name works well." },
    ],
    relatedTools: [
  ...
  "link-health-checker": {
    ...
    faqs: [
      { question: "Why do some links have no-follow?", answer: "Some outlets use no-follow for all external links as a general policy, not necessarily due to paid content." },
    ],
    relatedTools: [
      { title: "Coverage Tracker Template", slug: "coverage-tracker-template" },
      { title: "UTM Builder for PR Links", slug: "utm-builder-pr-links" },
  ...
  "media-kit-builder-lite": {
    ...
    faqs: [
      { question: "What assets should I include?", answer: "High-res logos, product shots, founder headshots, company timeline, and key facts." },
    ],
    relatedTools: [
      { title: "Boilerplate Refinery", slug: "boilerplate-refinery" },
      { title: "Press Release Structure Builder", slug: "press-release-structure-builder" },
  ...
  "journalist-timezone-converter": {
    ...
    faqs: [
      { question: "When should I avoid sending emails?", answer: "Avoid weekends, holidays, and outside 8 AM - 6 PM in the journalist's timezone." },
    ],
    relatedTools: [
      { title: "Embargo & Timing Planner", slug: "embargo-timing-planner" },
      { title: "Follow-Up Cadence Builder", slug: "follow-up-cadence-builder" },
  ...
  "compliance-disclosure-helper": {
    ...
    faqs: [
      { question: "What's the difference between #ad and #sponsored?", answer: "Both are acceptable. #ad is shorter and more commonly used, especially on Instagram." },
    ],
    relatedTools: [
  ...
  "influencer-brief-builder": {
    ...
    faqs: [
      { question: "Should I include specific hashtags?", answer: "Suggest hashtags but allow flexibility for the influencer's authentic voice." },
    ],
    relatedTools: [
  ...
  "rate-card-estimator-lite": {
    ...
    faqs: [
      { question: "What affects influencer rates?", answer: "Follower count, engagement rate, industry niche, content quality, and exclusivity requirements." },
    ],
    relatedTools: [
      { title: "Influencer Brief Builder", slug: "influencer-brief-builder" },
      { title: "Compliance & Disclosure Helper", slug: "compliance-disclosure-helper" },
  ...
  "hashtag-angle-finder": {
    ...
    faqs: [
      { question: "How many hashtags should influencers use?", answer: "Instagram: 5-10 strategic hashtags. TikTok: 3-5 trending hashtags. Quality over quantity." },
    ],
    relatedTools: [
      { title: "Influencer Brief Builder", slug: "influencer-brief-builder" },
      { title: "Rate Card Estimator", slug: "rate-card-estimator-lite" },
  ...
  "crisis-holding-statement-generator": {
    ...
    faqs: [
      { question: "How quickly should I respond?", answer: "Aim for within 2-4 hours for major issues. A holding statement buys time for a fuller response." },
    ],
    relatedTools: [
      { title: "Quote Polisher for PR", slug: "quote-polisher-pr" },
      { title: "Boilerplate Refinery", slug: "boilerplate-refinery" },
  ...
  "boilerplate-refinery": {
    ...
    faqs: [
      { question: "How long should a boilerplate be?", answer: "40-60 words is ideal for press releases. Have shorter (25 words) and longer (100 words) versions ready." },
    ],
    relatedTools: [
      { title: "Press Release Structure Builder", slug: "press-release-structure-builder" },
      { title: "Quote Polisher for PR", slug: "quote-polisher-pr" },
  ...
  "media-ai-query-builder": {
    ...
    faqs: [
      { question: "Can I modify the search after applying?", answer: "Yes, use this as a starting point and refine based on your specific needs." },
    ],
    relatedTools: [
      { title: "List Segmenter (Lite)", slug: "list-segmenter-lite" },
      { title: "Beat & Outlet Matcher", slug: "beat-outlet-matcher" },
  ...
  "pr-roi-snapshot-calculator": {
    ...
    faqs: [
      { question: "How accurate is earned media value?", answer: "It's a directional metric based on ad rate equivalencies. Focus on traffic and lead quality for true ROI." },
    ],
    relatedTools: [
      { title: "Coverage Tracker Template", slug: "coverage-tracker-template" },
      { title: "UTM Builder for PR Links", slug: "utm-builder-pr-links" },
  ...
  "coverage-analytics-dashboard": {
    ...
    category: "Analytics",
    inputLabel: "Coverage Data",
    inputPlaceholder: "Paste coverage URLs and key metrics for analysis...",
    outputTitle: "Analytics Snapshot",
    sampleOutput: [
      "📈 Total impressions: 1.8M across 12 placements",
      "🔁 Social shares: 4,300",
      "🌐 Domain authority average: 78",
      "🎯 Top-performing outlet: TechCrunch (28% of total reach)",
    ],
    howToUse: [
      "Review your top-performing placements",
      "Identify outlets worth deepening relationships with",
      "Share the snapshot with leadership and clients",
    ],
    faqs: [
      { question: "Where do the metrics come from?", answer: "Estimates blend public domain authority, social engagement, and traffic proxies." },
    ],
    relatedTools: [
      { title: "PR ROI Snapshot Calculator", slug: "pr-roi-snapshot-calculator" },
      { title: "Coverage Tracker Template", slug: "coverage-tracker-template" },
  ...
  "social-media-content-planner": {
    ...
    category: "Influencer",
    inputLabel: "Campaign Goals",
    inputPlaceholder: "Describe your campaign goals, audience, and key themes...",
    outputTitle: "30-Day Content Calendar",
    sampleOutput: [
      "🗓️ Week 1: Awareness — 3 posts, 2 stories, 1 reel",
      "🗓️ Week 2: Education — case study + carousel",
      "🗓️ Week 3: Social proof — testimonial reel",
      "🗓️ Week 4: Conversion — CTA-heavy posts",
    ],
    howToUse: [
      "Drop the calendar into your scheduling tool",
      "Assign owners for each piece of content",
      "Iterate weekly based on engagement",
    ],
    faqs: [
      { question: "Which platforms does it cover?", answer: "Instagram, TikTok, LinkedIn, and X by default — you can adapt for others." },
    ],
    relatedTools: [
      { title: "Hashtag & Angle Finder", slug: "hashtag-angle-finder" },
      { title: "Influencer Brief Builder", slug: "influencer-brief-builder" },
...
const ToolTemplate = () => {
  ...
  const currentTool: ToolData = toolsData[slug || ""] || {
  ...
  useEffect(() => {
    ...
    const description =
      currentTool.description.length > 155
      ...
      <section className="bg-background py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Link
              to="/tools"
              className="text-sm text-muted-foreground hover:text-primary inline-flex items-center mb-6"
            >
              ← All tools
            </Link>
            ...
            <Card className="p-8">
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <Button
                    variant="secondary"
                    onClick={() => copyToClipboard(currentTool.sampleOutput.join("\n"))}
                  >
