    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-xs font-medium tracking-[0.2em] text-muted-foreground mb-10">COMPARED*</p>
      ...
      <footer className="px-6 py-16 mt-12">
        <div className="max-w-6xl mx-auto grid md:grid-cols-5 gap-8 text-sm">
          <FooterCol title="Company" links={[
            ["About", "https://trymedia.ai/about"],
            ["Blog", "https://blog.trymedia.ai/"],
            ["Community", "https://discord.gg/zrFtSbzQ2W"],
          ]} />
          <FooterCol title="Support" links={[
            ["Support", "mailto:support@trymedia.ai"],
            ["Privacy Policy", "https://trymedia.ai/privacy-policy"],
            ["Terms of Service", "https://trymedia.ai/terms-of-service"],
          ]} />
          <div>
